...
<jsp:include page="layouts/header.jsp" >
    <jsp:param name="active_tab" value="3" />
</jsp:include>
...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Additional Data</h1>
                <form action="AdditionalCSVController" method="post" enctype="multipart/form-data">
                    <input type="file" name="bootstrap-file" />
                    <input type="text" name="notJson" value="true" hidden="">
                    <br>
                    <button type="submit" class="btn btn-primary" onclick="showLoader()">Add more Data</button>
                </form>
