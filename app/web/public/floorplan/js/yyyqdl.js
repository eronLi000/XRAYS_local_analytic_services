    ...
    function a(a) {
        a.each(function(a) {
            if (a && a.map) {
                ...
                b.exit().transition().style("opacity", 1E-6).remove();
                j.append("title");
                b.attr("class", function(b) {
                    return "d6-" + c(b.value).substring(0,1);
                }).select("title").text(function(b) {
                    return "Crowd Density: " + c(b.value).substring(0,1); + a.units
                });
                j.transition().style("opacity", 0.6);
                ...
                d.attr("transform", function(a) {
                    ...
                    j = j / 2;
                    d = d / (6 * j);
                    return "translate(" + i(b / (6 * j)) + "," + h(d) + ")"
                }).text(function(b) {
                    return c(b.value).substring(0,1) + a.units
                });
    ...
    function a(a) {
        a.each(function(a) {
            if (a) {
                ...
                g.enter().append("path").attr("class", "polygon").attr("vector-effect", "non-scaling-stroke").attr("pointer-events", "all").on("mousedown", function(a) {
...
d3.floorplan.pathplot = function() {
    function a(a) {
        a.each(function(a) {
            a && (a = d3.select(this).selectAll("path").data(a, function(a) {
                return a.id
            }), a.exit().transition().style("opacity", 1E-6).remove(), a.enter().append("path").attr("vector-effect", "non-scaling-stroke").attr("fill", "none").style("opacity", 1E-6).append("title"), a.attr("class", function(a) {
                return a.classes || a.id
            }).attr("d", function(a, d) {
                return i(c(a, d))
            }).select("title").text(function(a) {
                return a.title || a.id
